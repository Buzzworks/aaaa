...
from callcenter.models import (Campaign,CallDetail,AgentActivity,User,
	CdrFeedbck, UserVariable, CSS, CallBackContact, Abandonedcall,CurrentCallBack,
...
from crm.utility import validate_uploaded_phonebook
...
def fs_call():
	...
	"""
	try:
		campaign = Campaign.objects.filter(status="Active").prefetch_related()
...
def set_ad_campaign_status():
	""" setting true all the pd campaign and ad campaings in redis"""
	try:
