...
USER_FIELDS = ['username','email','password','group','role', 'first_name', 'last_name', 'wfh_numeric', 'employee_id','reporting_to','domain','call_protocol','status']

HOLIDAYS_FIELDS = ['name','holiday_date','description','status']

DNC_FIELDS = ["numeric","campaign","global_dnc"]
