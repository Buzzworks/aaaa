...
class Contact(models.Model):
	...
	uniqueid  = models.CharField(max_length =30, blank=True, null=True,db_index=True)
	...
	last_connected_user = models.CharField(max_length=100,null=True,blank=True,db_index=True)
